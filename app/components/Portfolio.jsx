...
export default function Portfolio() {
    return (
        // main div to return
        <div className="max-w-full flex-1 flex flex-col items-center justify-between py-16 px-4 sm:py-32 sm:px-8 md:px-96">
            {/* About section */}
                ...
                <section id="about" className="min-h-screen py-10 scroll-mt-20">
                    ...
                    <div className="flex flex-col lg:flex-row items-start gap-6 lg:gap-16">
                        ...
                        <div className="flex flex-col gap-5 w-full">
                            <p className="text-gray-300 text-center">Some technologies I am working with:</p>
                            ...
                            <div className="flex flex-wrap items-center gap-12 text-center justify-center">
                                ...
                                <a className="hover:text-white transition">
                                    ...
                                    <p className="text-sm mt-2">Spring <br/>Boot</p>
                                </a>
                            </div>
